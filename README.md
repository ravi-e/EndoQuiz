...
The project features a robust, self-maintaining intelligence layer powered by **GitHub Actions** and the Gemini API (including `imagen-3.0-generate-002` for visual assets).
